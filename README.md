...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/qt-main-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/qt-main-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
It is possible to list all of the versions of `qt6-main` available on your platform:
...
```
pixi search qt6-main --channel conda-forge
```
